    ...
    return (
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            <View style={styles.container}>
                ...
                <Input value={phone} containerStyle={styles.textInput} placeholder="手机号" editable maxLength={ 11} onChangeText={setPhone}  leftIcon={<Text style={{fontSize:20,paddingRight:2}}>+86</Text>}/>
                
                <Input ref={passwordInputRef} value={password} containerStyle={styles.textInput} placeholder="密码" editable onChangeText={setPassword} />
                {password.length > 0 &&  (
                  <TouchableOpacity onPress={handleClearPwd} style={{ marginRight: 16, paddingBottom: 7 }}>
                ...
                <Button  containerStyle={styles.loginButton} title="登录" onPress={() => navigation.navigate("DiaryList")} />
                <View
                  style={{
                    flexDirection: 'row',
                    alignItems: 'center',
